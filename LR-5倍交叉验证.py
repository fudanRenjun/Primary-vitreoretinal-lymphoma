...
dump(model, 'E:/RS/2分类/特征筛选/LR/final/LR-2.pkl')
...
shap.plots.beeswarm(shap_values2,
                    order=shap_values2.abs.max(0), max_display=23)

shap.plots.scatter(shap_values2[:, "LYMPH%"])
shap.plots.scatter(shap_values2[:, "WBC"])
shap.plots.waterfall(shap_values2[1])
shap.plots.waterfall(shap_values2[50])
shap.plots.waterfall(shap_values2[100])
shap.plots.waterfall(shap_values2[200])
shap.plots.waterfall(shap_values2[250])
shap.plots.waterfall(shap_values2[300])
shap.plots.waterfall(shap_values2[311])
